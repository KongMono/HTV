...
public class CustomsListView extends ListView implements OnScrollListener {
	...
	public CustomsListView(Context context) {
		super(context);
		init(context);
	}

	public CustomsListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	public interface OnRefreshListener {
		 ...
		 * <p>
		 * A call to {@link CustomsListView #onRefreshComplete()} is
